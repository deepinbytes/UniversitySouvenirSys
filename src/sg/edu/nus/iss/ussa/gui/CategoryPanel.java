...
public class CategoryPanel extends javax.swing.JPanel {
    ...
    public void jbinit() {
        tb2.setModel(new CategoryTableModel());
    ...
    private void initComponents() {
        ...
        jPanel18.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Category List", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.ABOVE_TOP, new java.awt.Font("Tahoma", 1, 14), new java.awt.Color(0, 0, 204))); // NOI18N
        ...
        jButton25.setBounds(1230, 40, 90, 70);
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        try {
            CategoryTableModel ab = new CategoryTableModel(0, 0);
            tb2.setModel(ab);
    ...
    private void jButton20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton20ActionPerformed
        try {
            CategoryTableModel ab = new CategoryTableModel(1, tb2.getSelectedRow());
            tb2.setModel(ab);
            tb2.setModel(new CategoryTableModel());
        } catch (IOException ex) {
            Logger.getLogger(CategoryPanel.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButton26ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton26ActionPerformed
        try {
            CategoryTableModel ab = new CategoryTableModel(2, tb2.getSelectedRow());
            tb2.setModel(ab);
            tb2.setModel(new CategoryTableModel());
        } catch (IOException ex) {
            Logger.getLogger(CategoryPanel.class.getName()).log(Level.SEVERE, null, ex);
